...
## 24. **Что такое предохранители (Error Boundaries)?**
...
## 26. **Что такое инверсия наследования (Inheritance Inversion)?**
...
## 33. **Разница между memo и useMemo?**
...
## 35. **Техники оптимизации перфоманса React?**
...
## 36. **Лучшие практики безопасности в React?**
...
## 37. **Что такое обратный поток данных в React?**
...
## 38. **Что такое батчинг ререндеров?**
...
## 40. **Что такое конкурентный режим?**

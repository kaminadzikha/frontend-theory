...
## 32. Какие элементы ООП поддерживаются в TypeScript? `(Требуется доработка)`
...
## 33. Модификаторы доступа в TypeScript?
...
## 34. Разница между абстрактным классом (abstract class) и интерфейсом (interface)?
...
## 35. Что такое директивы с тремя наклонными чертами (Triple-Slash Directives), их типы?
...
## 36. Разница между enum и const enum?

...
## 18. Что такое пространства имён?
...
## 19. Разница между внутренним (Internal Module) и внешним модулями (External Module)?
...
## 31. Какие элементы ООП поддерживаются в TypeScript? (Требуется исправление)
...
## 32. Модификаторы доступа в TypeScript?
...
## 33. Разница между абстрактным классом (abstract class) и интерфейсом (interface)?
...
## 34. Что такое директивы с тремя наклонными чертами (Triple-Slash Directives), их типы?
